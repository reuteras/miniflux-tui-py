...
- sync uv.lock with mypy 2.3.1 bump from dependabot

### MAINTENANCE

- pre-commit autoupdate
- bump mypy from 2.3.0 to 2.3.1 (#866) 🤖
- bump the actions-deps group with 6 updates (#867) 🤖
- switch from httpx to httpx2 and bump version to 0.8.18
- Release v0.8.19 (#868)
...
- pre-commit autoupdate (#832)
- bump the actions-deps group with 4 updates (#833) 🤖
- Release v0.8.9 (#834)
...
- Release v0.8.3 (#811)
- bump the actions-deps group with 5 updates (#812) 🤖
