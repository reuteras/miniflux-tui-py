...
class HelpScreen(Screen):
    ...
    def compose(self) -> ComposeResult:  # noqa: PLR0915
        ...
        with VerticalScroll():
            ...
            yield Static("  G               Enable grouping and expand all feeds")
            yield Static("  Z               Collapse all feeds")
            yield Static("  o               Toggle fold/unfold on feed header")
            yield Static("  u               Show unread entries only")
            yield Static("  t               Show starred entries only")
            ...
            yield Static("  r               Refresh current feed (fetch new RSS content)")
            yield Static("  R               Refresh all feeds (fetch new RSS content)")
            yield Static("  ,               Sync entries (reload from server)")
            yield Static("")
            ...
            yield Static("  H               Show reading history")
            ...
            yield Static("  m               Toggle read/unread")
            yield Static("  *               Toggle star")
            yield Static("  Esc or q        Return to main entry list")
